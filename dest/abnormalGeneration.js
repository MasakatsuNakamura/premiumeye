$(document).ready(function() {
  ...
  return $.getJSON("https://s3-ap-northeast-1.amazonaws.com/sanix-data-analysis/fhRK0XGVb3cR1r1S3x9j3j3DRFGUyRYC/abnormalGeneration/" + strDate + ".json", (function(_this) {
    return function(json) {
      ...
      return $.getJSON("https://s3-ap-northeast-1.amazonaws.com/sanix-data-analysis/fhRK0XGVb3cR1r1S3x9j3j3DRFGUyRYC/pv_sensors.json", function(pvsensors) {
        var header, i, id, item, j, k, key, keys, l, len, len1, len2, len3, line, list, num, res;
        ...
        for (i = 0, len = keys.length; i < len; i++) {
          ...
          for (k = 0, len2 = list.length; k < len2; k++) {
            ...
            for (l = 0, len3 = header.length; l < len3; l++) {
              item = header[l];
              res += '<td>' + line[item] + '</td>';
            }
            res += '</tr>';
